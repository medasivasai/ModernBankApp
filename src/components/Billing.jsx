...
const billing = () =>  (
  <section id='product' className={layout.sectionReverse}>
    <div className={layout.sectionImgReverse}>
      <img src={bill} alt="billing"  className='w-[100%] h-[100%] realtive z-[3124]'/>
    ...
    <div className={layout.sectionInfo}>
      ...
      <div className='flex flex-row flex-wrap sm:mt-10 mt-6'>
        <img src={apple} alt="App store for apple"
        className='w-[128px] h-[42px] object-contain mr-5 cursoe-pointer' />
        <img src={google} alt="play store"
        className='w-[128px] h-[42px] object-contain  cursoe-pointer' />
      </div>
    </div>
  </section>
)
